; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmp4n7tDD/postprocessed.ll'
...
pre_entry:
  %first_0 = call i64 @__sum_by_loop(i64 %n)
  %second_0 = call i64 @__sum_by_formula(i64 %n)
  %isSame_0 = icmp eq i64 %first_0, %second_0
  call void @print_int(i64 %first_0)
  call void @print_newline()
  call void @print_int(i64 %second_0)
  call void @print_newline()
  call void @print_bool(i1 %isSame_0)
  call void @print_newline()
  ret void
}

define dso_local i64 @__sum_by_loop(i64 %n) {
pre_entry:
  br label %for_start

for_start:                                        ; preds = %for, %pre_entry
  %i_1 = phi i64 [ %i_2, %for ], [ 1, %pre_entry ]
  %sum_1 = phi i64 [ %sum_2, %for ], [ 0, %pre_entry ]
  %con_0.not = icmp sgt i64 %i_1, %n
  br i1 %con_0.not, label %end, label %for

for:                                              ; preds = %for_start
  %sum_2 = add i64 %sum_1, %i_1
  %i_2 = add i64 %i_1, 1
  br label %for_start

end:                                              ; preds = %for_start
  %sum_1.lcssa = phi i64 [ %sum_1, %for_start ]
  ret i64 %sum_1.lcssa
}

define dso_local i64 @__sum_by_formula(i64 %n) {
pre_entry:
  %n_1_0 = add i64 %n, 1
