; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpPjIvcI/compile.ll'
...
loop_body:                                        ; preds = %b0, %loop_body
  ...
  tail call void @__printBinary(i64 %loop_counter_11) #4
...
pre_entry:
  ...
  br i1 %cond_0, label %common.ret, label %rec

common.ret:                                       ; preds = %pre_entry, %rec
  ret void

rec:                                              ; preds = %pre_entry
  %n.frozen = freeze i64 %n
  %v1_0 = sdiv i64 %n.frozen, 2
  %0 = mul i64 %v1_0, 2
  %.decomposed = sub i64 %n.frozen, %0
  tail call void @__printBinary(i64 %v1_0)
  %1 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %.decomposed) #4
...
loop_body.i:                                      ; preds = %0, %loop_body.i
  ...
  tail call void @__printBinary(i64 %loop_counter_11.i) #4
