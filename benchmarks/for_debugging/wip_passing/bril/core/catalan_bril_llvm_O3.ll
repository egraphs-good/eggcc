; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpZSflhk/compile.ll'
...
b0:
  %catn_0.i = tail call i64 @__catalan(i64 10) #4
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i) #4
  %1 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.1 = tail call i64 @__catalan(i64 11) #4
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.1) #4
  %3 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.2 = tail call i64 @__catalan(i64 12) #4
  %4 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.2) #4
  %5 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.3 = tail call i64 @__catalan(i64 13) #4
  %6 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.3) #4
  %7 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.4 = tail call i64 @__catalan(i64 14) #4
  %8 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.4) #4
  %9 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.5 = tail call i64 @__catalan(i64 15) #4
  %10 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.5) #4
  %11 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.6 = tail call i64 @__catalan(i64 16) #4
  %12 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.6) #4
  %13 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.7 = tail call i64 @__catalan(i64 17) #4
  %14 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.7) #4
  %15 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.8 = tail call i64 @__catalan(i64 18) #4
  %16 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.8) #4
  %17 = tail call i32 @putchar(i32 10) #4
  %catn_0.i.9 = tail call i64 @__catalan(i64 19) #4
  %18 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0.i.9) #4
...
pre_entry:
  ...
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %catn_0) #4
  %1 = tail call i32 @putchar(i32 10) #4
  ret void
}
...
while.body:                                       ; preds = %else, %while.body
  ...
  %guard1_0.not = icmp slt i64 %n_1, %idx_2
