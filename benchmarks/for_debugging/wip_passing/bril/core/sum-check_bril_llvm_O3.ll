; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpXVHKBi/compile.ll'
...
for.i.i.preheader:                                ; preds = %b0, %for.i.i.preheader
  %indvars.iv4 = phi i65 [ 72, %b0 ], [ %indvars.iv.next5, %for.i.i.preheader ]
  %indvars.iv2 = phi i65 [ 18, %b0 ], [ %indvars.iv.next3, %for.i.i.preheader ]
  %indvars.iv = phi i64 [ 19, %b0 ], [ %indvars.iv.next, %for.i.i.preheader ]
  %loop_counter_11 = phi i64 [ 10, %b0 ], [ %n_1_0.i.i, %for.i.i.preheader ]
  %0 = lshr exact i65 %indvars.iv4, 1
  %1 = trunc i65 %0 to i64
  %2 = add i64 %indvars.iv, %1
  %n_1_0.i.i = add nuw nsw i64 %loop_counter_11, 1
  %multi_0.i.i = mul i64 %n_1_0.i.i, %loop_counter_11
  %sum_0.i.i = sdiv i64 %multi_0.i.i, 2
  %isSame_0.i = icmp eq i64 %2, %sum_0.i.i
  %3 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %2) #5
  %4 = tail call i32 @putchar(i32 10) #5
  %5 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %sum_0.i.i) #5
  %6 = tail call i32 @putchar(i32 10) #5
  %..i.i = select i1 %isSame_0.i, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0)
  %7 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) %..i.i) #5
  %8 = tail call i32 @putchar(i32 10) #5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 2
  %indvars.iv.next3 = add nuw nsw i65 %indvars.iv2, 2
...
__sum_by_loop.exit:                               ; preds = %for.i, %pre_entry
  ...
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %sum_1.lcssa.i) #5
  %1 = tail call i32 @putchar(i32 10) #5
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %sum_0.i) #5
  %3 = tail call i32 @putchar(i32 10) #5
  %..i = select i1 %isSame_0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0)
  %4 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) %..i) #5
