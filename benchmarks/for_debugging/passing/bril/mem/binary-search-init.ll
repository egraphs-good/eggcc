...
define dso_local i64 @__binary_search(i64* %array, i64 %target, i64 %left, i64 %right) {
pre_entry:
...
check_equal:
  ...
  %midval_0 = load i64, i64* %midloc_0
  %equal_cond_0 = icmp eq i64 %target, %midval_0
  br i1 %equal_cond_0, label %found, label %check_gt
found:
  ret i64 %mid_1
check_gt:
  %gt_cond_0 = icmp sgt i64 %target, %midval_0
  br i1 %gt_cond_0, label %call_gt, label %call_lt
call_gt:
  %newleft_0 = add i64 %left, 1
  %output_0 = call i64 @__binary_search(i64* %array, i64 %target, i64 %newleft_0, i64 %right)
  ret i64 %output_0
call_lt:
  %newright_0 = sub i64 %right, 1
  %output_1 = call i64 @__binary_search(i64* %array, i64 %target, i64 %left, i64 %newright_0)
  ret i64 %output_1
end:
  ret i64 -1
...
pre_entry:
  %array_0 = call i64* @__pack(i64 5, i64 %e1, i64 %e2, i64 %e3, i64 %e4, i64 %e5)
  %output_0 = call i64 @__binary_search(i64* %array_0, i64 7, i64 0, i64 4)
