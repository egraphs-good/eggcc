...
pre_entry:
  ...
  %tot_0 = call i64 @__totient(i64 %n)
  call void @print_int(i64 %tot_0)
  call void @print_newline()
  ret void
...
define dso_local i64 @__totient(i64 %n) {
pre_entry:
  br label %for.set.cond
for.set.cond:
  %p_1 = phi i64 [ %p_2, %else_lbl ], [ 2, %pre_entry ]
  %result_1 = phi i64 [ %result_3, %else_lbl ], [ %n, %pre_entry ]
  %n_1 = phi i64 [ %n_4, %else_lbl ], [ %n, %pre_entry ]
  %pp_0 = mul i64 %p_1, %p_1
  %cond_0 = icmp sle i64 %pp_0, %n_1
  br i1 %cond_0, label %for.set.body, label %for.set.end
for.set.body:
  %npmod_0 = call i64 @__mod(i64 %n_1, i64 %p_1)
  %if_cond_0 = icmp eq i64 %npmod_0, 0
  br i1 %if_cond_0, label %if_lbl, label %else_lbl
if_lbl:
  %npmod_1 = phi i64 [ %npmod_2, %while.body ], [ %npmod_0, %for.set.body ]
  %n_2 = phi i64 [ %npdiv_0, %while.body ], [ %n_1, %for.set.body ]
  %npmod_2 = call i64 @__mod(i64 %n_2, i64 %p_1)
  %while_cond_0 = icmp eq i64 %npmod_2, 0
  br i1 %while_cond_0, label %while.body, label %while.end
while.body:
  %npdiv_0 = sdiv i64 %n_2, %p_1
  br label %if_lbl
while.end:
  %resdiv_0 = sdiv i64 %result_1, %p_1
  %result_2 = sub i64 %result_1, %resdiv_0
  br label %else_lbl
else_lbl:
  %npmod_3 = phi i64 [ %npmod_2, %while.end ], [ %npmod_0, %for.set.body ]
  %result_3 = phi i64 [ %result_2, %while.end ], [ %result_1, %for.set.body ]
  %n_4 = phi i64 [ %n_2, %while.end ], [ %n_1, %for.set.body ]
  %p_2 = add i64 %p_1, 1
  br label %for.set.cond
for.set.end:
...
pre_entry:
  %ad_0 = sdiv i64 %a, %b
  %mad_0 = mul i64 %b, %ad_0
  %ans_0 = sub i64 %a, %mad_0
  ret i64 %ans_0
