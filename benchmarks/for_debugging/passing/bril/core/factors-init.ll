...
pre_entry:
  br label %loopcheck
loopcheck:
  %fac_1 = phi i64 [ %fac_2, %ifno ], [ %fac_1, %ifyes ], [ 2, %pre_entry ]
  %num_1 = phi i64 [ %num_1, %ifno ], [ %num_2, %ifyes ], [ %num, %pre_entry ]
  %ispos_0 = icmp slt i64 1, %num_1
  br i1 %ispos_0, label %loopbody, label %loopend
loopbody:
  %quo_0 = sdiv i64 %num_1, %fac_1
  %tmp_0 = mul i64 %quo_0, %fac_1
  %mod_0 = sub i64 %num_1, %tmp_0
  %iszero_0 = icmp eq i64 %mod_0, 0
  br i1 %iszero_0, label %ifyes, label %ifno
ifyes:
  call void @print_int(i64 %fac_1)
  call void @print_newline()
  %num_2 = sdiv i64 %num_1, %fac_1
  br label %loopcheck
ifno:
  %fac_2 = add i64 %fac_1, 1
  br label %loopcheck
loopend:
  ret void
