; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpDARHRi/up-arrow-init.ll'
...
b0:
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %ans_0)
  %1 = tail call i32 @putchar(i32 10)
  ret void
}
...
4:                                                ; preds = %0
  %ans_0.i = tail call i64 @__up_arrow(i64 2, i64 3, i64 4)
  %5 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %ans_0.i)
