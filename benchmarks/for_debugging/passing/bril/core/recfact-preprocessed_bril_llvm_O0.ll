; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmp1faEJK/postprocessed.ll'
...
else.0:                                           ; preds = %b2, %pre_entry
  %v8_0 = add nsw i64 %x, -1
  %v9_0 = call i64 @__fac(i64 %v8_0)
  %v10_0 = mul i64 %v9_0, %x
  ret i64 %v10_0
}
