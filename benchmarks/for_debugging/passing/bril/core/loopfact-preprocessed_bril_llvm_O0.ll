; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpV8Xj4g/postprocessed.ll'
...
for.cond.2:                                       ; preds = %for.body.2, %pre_entry
  %i_1 = phi i64 [ %v12_0, %for.body.2 ], [ %input, %pre_entry ]
  %result_1 = phi i64 [ %v9_0, %for.body.2 ], [ 1, %pre_entry ]
  %v6_0 = icmp sgt i64 %i_1, 0
  br i1 %v6_0, label %for.body.2, label %for.end.2

for.body.2:                                       ; preds = %for.cond.2
  %v9_0 = mul i64 %result_1, %i_1
  %v12_0 = add nsw i64 %i_1, -1
  br label %for.cond.2

for.end.2:                                        ; preds = %for.cond.2
  %result_1.lcssa = phi i64 [ %result_1, %for.cond.2 ]
