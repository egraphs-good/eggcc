...
b0:
  %ans_0 = call i64 @__up_arrow(i64 2, i64 3, i64 4)
  call void @print_int(i64 %ans_0)
...
define dso_local i64 @__up_arrow(i64 %num, i64 %arrows, i64 %repeats) {
pre_entry:
  br label %loopstart
loopstart:
  %i_1 = phi i64 [ %i_2, %finally ], [ 1, %pre_entry ]
  %ans_1 = phi i64 [ %ans_4, %finally ], [ %num, %pre_entry ]
  %keepgoing_0 = icmp slt i64 %i_1, %repeats
  br i1 %keepgoing_0, label %loopbody, label %endloop
loopbody:
  %base_case_0 = icmp sle i64 %arrows, 1
  br i1 %base_case_0, label %base, label %arrowsgreaterthan1
base:
  %ans_2 = mul i64 %ans_1, %num
  br label %finally
arrowsgreaterthan1:
  %new_arrows_0 = sub i64 %arrows, 1
  %ans_3 = call i64 @__up_arrow(i64 %num, i64 %new_arrows_0, i64 %ans_1)
  br label %finally
finally:
  %ans_4 = phi i64 [ %ans_3, %arrowsgreaterthan1 ], [ %ans_2, %base ]
  %i_2 = add i64 %i_1, 1
  br label %loopstart
endloop:
  ret i64 %ans_4
