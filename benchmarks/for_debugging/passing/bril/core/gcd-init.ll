...
pre_entry:
  br label %cmp.val
cmp.val:
  %v1_1 = phi i64 [ %v1_1, %else.2 ], [ %v3_2, %if.2 ], [ %op2, %pre_entry ]
  %v0_1 = phi i64 [ %v3_2, %else.2 ], [ %v0_1, %if.2 ], [ %op1, %pre_entry ]
  %v2_0 = icmp slt i64 %v0_1, %v1_1
  br i1 %v2_0, label %if.1, label %else.1
if.1:
  %v3_0 = sub i64 %v1_1, %v0_1
  br label %loop.bound
else.1:
  %v3_1 = sub i64 %v0_1, %v1_1
  br label %loop.bound
loop.bound:
