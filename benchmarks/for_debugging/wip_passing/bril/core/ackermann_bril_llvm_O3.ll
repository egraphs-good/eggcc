; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpk45oy6/compile.ll'
...
loop_body:                                        ; preds = %b0, %loop_body
  ...
  %tmp_0.i = tail call i64 @__ack(i64 2, i64 %loop_counter_11) #4
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %tmp_0.i) #4
...
pre_entry:
  ...
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %tmp_0) #4
  %1 = tail call i32 @putchar(i32 10) #4
  ret void
}
...
loop_body.i:                                      ; preds = %0, %loop_body.i
  ...
  %tmp_0.i.i = tail call i64 @__ack(i64 2, i64 %loop_counter_11.i) #4
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %tmp_0.i.i) #4
