; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpKatPZX/postprocessed.ll'
...
loop_cond:                                        ; preds = %loop_body, %b0
  ...
  %loop_cond_0 = icmp slt i64 %loop_counter_1, 10000
...
cond:                                             ; preds = %print
  %eq_one_0 = icmp eq i64 %x_1, 1
  br i1 %eq_one_0, label %end, label %loop

loop:                                             ; preds = %cond
  %half_0 = sdiv i64 %x_1, 2
  %doublehalf_0 = shl nsw i64 %half_0, 1
  %even_0 = icmp eq i64 %x_1, %doublehalf_0
  br i1 %even_0, label %even, label %odd

even:                                             ; preds = %loop
  %x_2 = sdiv i64 %x_1, 2
  br label %print.backedge

print.backedge:                                   ; preds = %even, %odd
  %x_1.be = phi i64 [ %x_4, %odd ], [ %x_2, %even ]
  br label %print
...
print:                                            ; preds = %print.backedge, %pre_entry
  %x_1 = phi i64 [ %x, %pre_entry ], [ %x_1.be, %print.backedge ]
  call void @print_int(i64 %x_1)
