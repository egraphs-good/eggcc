...
false:
  br label %for.outer.cond
for.outer.cond:
  %t2_2 = phi i64 [ %t2_3, %if.outer.end ], [ %a, %false ], [ 2, %true ]
  %t3_0 = icmp sle i64 %t2_2, %b
  br i1 %t3_0, label %for.outer.body, label %for.outer.end
for.outer.body:
  %t5_0 = icmp eq i64 1, 1
...
for.inner.cond:
  ...
  %t9_0 = icmp sle i64 %t6_1, %t8_0
  br i1 %t9_0, label %for.inner.body, label %for.inner.end
for.inner.body:
  %t10_0 = call i64 @__mod(i64 %t2_2, i64 %t6_1)
  %t12_0 = icmp eq i64 %t10_0, 0
  br i1 %t12_0, label %if.inner.body, label %if.inner.end
if.inner.body:
  %t5_1 = icmp eq i64 1, 2
  br label %for.inner.end
if.inner.end:
  %t6_2 = add i64 1, %t6_1
  br label %for.inner.cond
for.inner.end:
  %t5_2 = phi i1 [ %t5_1, %if.inner.body ], [ %t5_0, %for.inner.cond ]
  %t6_3 = add i64 %t6_1, 1
  br i1 %t5_2, label %if.outer.body, label %if.outer.end
if.outer.body:
