...
pre_entry:
  %v3_0 = sub i64 10007, 2
  br label %for.cond.6
for.cond.6:
  %a_1 = phi i64 [ %v28_0, %endif.11 ], [ %n, %pre_entry ]
  %ans_1 = phi i64 [ %ans_3, %endif.11 ], [ 1, %pre_entry ]
  %m_1 = phi i64 [ %v31_0, %endif.11 ], [ %v3_0, %pre_entry ]
  %v10_0 = icmp sgt i64 %m_1, 0
  br i1 %v10_0, label %for.body.6, label %for.end.6
for.body.6:
  %v15_0 = sdiv i64 %m_1, 2
  %v17_0 = mul i64 %v15_0, 2
  %v18_0 = icmp eq i64 %m_1, %v17_0
  br i1 %v18_0, label %then.11, label %else.11
then.11:
  br label %endif.11
else.11:
  %v21_0 = mul i64 %ans_1, %a_1
  %v23_0 = call i64 @__mod(i64 %v21_0, i64 10007)
  br label %endif.11
endif.11:
  %ans_3 = phi i64 [ %v23_0, %else.11 ], [ %ans_1, %then.11 ]
  %v26_0 = mul i64 %a_1, %a_1
  %v28_0 = call i64 @__mod(i64 %v26_0, i64 10007)
  %v31_0 = sdiv i64 %m_1, 2
  br label %for.cond.6
for.end.6:
  call void @print_int(i64 %ans_3)
...
define dso_local i64 @__mod(i64 %n, i64 %p) {
pre_entry:
  %v3_0 = sdiv i64 %n, %p
  %v5_0 = mul i64 %v3_0, %p
  %v6_0 = sub i64 %n, %v5_0
