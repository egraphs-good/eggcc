; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmptP1REj/fitsinside-init.ll'
...
loop4_body:                                       ; preds = %loop4_cond.preheader, %loop4_body
  ...
  %.str..str.1.i.i = select i1 %ret_val_0.i.i, ptr @.str, ptr @.str.1
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) %.str..str.1.i.i)
  %1 = tail call i32 @putchar(i32 10)
...
pre_entry:
  ...
  %.str..str.1.i = select i1 %ret_val_0.i, ptr @.str, ptr @.str.1
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) %.str..str.1.i)
  %1 = tail call i32 @putchar(i32 10)
  ret void
}
...
loop4_body.i:                                     ; preds = %loop4_body.i, %loop4_cond.preheader.i
  ...
  %.str..str.1.i.i.i = select i1 %ret_val_0.i.i.i, ptr @.str, ptr @.str.1
  %4 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) %.str..str.1.i.i.i)
