; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpWvMneO/compile.ll'
...
loopbody.lr.ph.i.preheader:                       ; preds = %__orig_main.exit, %b0
...
ifyes.i:                                          ; preds = %loopbody.i
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %fac_1.ph5.i) #3
...
ifyes:                                            ; preds = %loopbody
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %fac_1.ph5) #3
  %1 = tail call i32 @putchar(i32 10) #3
...
define dso_local i32 @main(i32 %argc, i8** nocapture readnone %argv) local_unnamed_addr {
  ...
  %.not = icmp eq i32 %1, 0
  br i1 %.not, label %loopbody.lr.ph.i.preheader.i, label %codeRepl
...
ifyes.i.i:                                        ; preds = %loopbody.i.i
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %fac_1.ph5.i.i) #3
