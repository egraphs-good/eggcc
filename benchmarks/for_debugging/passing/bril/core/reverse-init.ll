...
pre_entry:
  br label %for.cond.3
for.cond.3:
  %notdone_1 = phi i1 [ %notdone_1, %for.incre ], [ 0, %if.body ], [ 1, %pre_entry ]
  %result_1 = phi i64 [ %result_3, %for.incre ], [ %result_3, %if.body ], [ 0, %pre_entry ]
  %n_1 = phi i64 [ %a_0, %for.incre ], [ %a_0, %if.body ], [ %input, %pre_entry ]
  br i1 %notdone_1, label %for.body.3, label %for.end.3
for.body.3:
  %a_0 = sdiv i64 %n_1, 10
  %floor_0 = mul i64 %a_0, 10
  %remainder_0 = sub i64 %n_1, %floor_0
  %result_2 = mul i64 %result_1, 10
  %result_3 = add i64 %result_2, %remainder_0
  %comp1_0 = icmp eq i64 %a_0, 0
...
for.incre:
  br label %for.cond.3
for.end.3:
  call void @print_int(i64 %result_1)
