...
define dso_local i64* @__pack(i64 %size, i64 %n1, i64 %n2, i64 %n3, i64 %n4, i64 %n5, i64 %n6, i64 %n7, i64 %n8, i64 %n9, i64 %n10) {
pre_entry:
  %z0 = mul i64 %size, 8
  ...
  %i_6 = add i64 %i_5, 1
  %loc_6 = getelementptr inbounds i64, i64* %array_0, i64 %i_6
  store i64 %n7, i64* %loc_6
  %i_7 = add i64 %i_6, 1
  %loc_7 = getelementptr inbounds i64, i64* %array_0, i64 %i_7
  store i64 %n8, i64* %loc_7
  %i_8 = add i64 %i_7, 1
  %loc_8 = getelementptr inbounds i64, i64* %array_0, i64 %i_8
  store i64 %n9, i64* %loc_8
  %i_9 = add i64 %i_8, 1
  %loc_9 = getelementptr inbounds i64, i64* %array_0, i64 %i_9
  store i64 %n10, i64* %loc_9
  ret i64* %array_0

}


define dso_local i64 @__max(i64 %n, i64 %m) {
pre_entry:
  %condi_0 = icmp slt i64 %n, %m
  br i1 %condi_0, label %less, label %biggereq
less:
  ret i64 %m
biggereq:
  ret i64 %n
...
pre_entry:
  %array_0 = call i64* @__pack(i64 10, i64 1, i64 2, i64 3, i64 4, i64 5, i64 -10, i64 -10, i64 50, i64 50, i64 -12)
  br label %loop
loop:
  %i_1 = phi i64 [ %i_2, %bodyi ], [ 0, %pre_entry ]
  %max_sum_1 = phi i64 [ %max_sum_2, %bodyi ], [ 0, %pre_entry ]
  %sum_1 = phi i64 [ %sum_2, %bodyi ], [ 0, %pre_entry ]
  %condi_0 = icmp slt i64 %i_1, 10
  br i1 %condi_0, label %bodyi, label %done
bodyi:
  %loc_0 = getelementptr inbounds i64, i64* %array_0, i64 %i_1
  %elem_0 = load i64, i64* %loc_0
  %sum_incr_0 = add i64 %sum_1, %elem_0
  %sum_2 = call i64 @__max(i64 0, i64 %sum_incr_0)
  %max_sum_2 = call i64 @__max(i64 %max_sum_1, i64 %sum_2)
  %i_2 = add i64 %i_1, 1
  br label %loop
done:
  %val_0 = add i64 %max_sum_1, %x
