; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpcvjQb9/binary-fmt-init.ll'
...
loop_body:                                        ; preds = %b0, %loop_body
  ...
  tail call void @__printBinary(i64 %loop_counter_11)
...
pre_entry:
  tail call void @__printBinary(i64 %n)
  ret void
}

; Function Attrs: nofree nounwind
define dso_local void @__printBinary(i64 %n) local_unnamed_addr #0 {
pre_entry:
  %a0.fr.i = freeze i64 %n
  %cond_0 = icmp eq i64 %a0.fr.i, 0
  br i1 %cond_0, label %common.ret1, label %rec

common.ret1:                                      ; preds = %pre_entry, %rec
  ret void

rec:                                              ; preds = %pre_entry
  %v1_0 = sdiv i64 %a0.fr.i, 2
  %0 = mul i64 %v1_0, 2
  %.decomposed = sub i64 %a0.fr.i, %0
  tail call void @__printBinary(i64 %v1_0)
  %1 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %.decomposed)
  %2 = tail call i32 @putchar(i32 10)
  br label %common.ret1
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define dso_local i64 @__mod(i64 %a0, i64 %a1) local_unnamed_addr #2 {
pre_entry:
  %a0.fr = freeze i64 %a0
  %0 = srem i64 %a0.fr, %a1
  ret i64 %0
...
loop_body.i:                                      ; preds = %0, %loop_body.i
  ...
  tail call void @__printBinary(i64 %loop_counter_11.i)
