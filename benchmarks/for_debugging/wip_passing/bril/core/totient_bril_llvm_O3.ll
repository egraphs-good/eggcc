; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpGdmJ0C/compile.ll'
...
for.set.body.i.i.preheader:                       ; preds = %__orig_main.exit, %b0
  ...
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %loop_counter_11) #5
...
for.set.body.i.i:                                 ; preds = %for.set.body.i.i.preheader, %else_lbl.i.i
  ...
  %p_14.i.i = phi i64 [ %p_2.i.i, %else_lbl.i.i ], [ 2, %for.set.body.i.i.preheader ]
  %2 = srem i64 %n_18.i.i, %p_14.i.i
...
while.body.i.i:                                   ; preds = %for.set.body.i.i, %while.body.i.i
  %n_22.i.i = phi i64 [ %npdiv_0.i.i, %while.body.i.i ], [ %n_18.i.i, %for.set.body.i.i ]
  %npdiv_0.i.i = sdiv i64 %n_22.i.i, %p_14.i.i
  %3 = srem i64 %npdiv_0.i.i, %p_14.i.i
  %while_cond_0.i.i = icmp eq i64 %3, 0
  br i1 %while_cond_0.i.i, label %while.body.i.i, label %while.end.i.i

while.end.i.i:                                    ; preds = %while.body.i.i
  %resdiv_0.i.i = sdiv i64 %result_17.i.i, %p_14.i.i
...
__orig_main.exit:                                 ; preds = %for.set.end.i.i, %final_if_label.i.i
  ...
  %4 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %result_5.i.i) #5
...
pre_entry:
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %n) #5
  %1 = tail call i32 @putchar(i32 10) #5
  %cond_0.not3.i = icmp slt i64 %n, 4
  br i1 %cond_0.not3.i, label %for.set.end.i, label %for.set.body.i

for.set.body.i:                                   ; preds = %pre_entry, %else_lbl.i
  %n_18.i = phi i64 [ %n_4.i, %else_lbl.i ], [ %n, %pre_entry ]
  %result_17.i = phi i64 [ %result_3.i, %else_lbl.i ], [ %n, %pre_entry ]
  %p_14.i = phi i64 [ %p_2.i, %else_lbl.i ], [ 2, %pre_entry ]
  %2 = srem i64 %n_18.i, %p_14.i
...
while.body.i:                                     ; preds = %for.set.body.i, %while.body.i
  %n_22.i = phi i64 [ %npdiv_0.i, %while.body.i ], [ %n_18.i, %for.set.body.i ]
  %npdiv_0.i = sdiv i64 %n_22.i, %p_14.i
  %3 = srem i64 %npdiv_0.i, %p_14.i
  %while_cond_0.i = icmp eq i64 %3, 0
  br i1 %while_cond_0.i, label %while.body.i, label %while.end.i

while.end.i:                                      ; preds = %while.body.i
  %resdiv_0.i = sdiv i64 %result_17.i, %p_14.i
...
__totient.exit:                                   ; preds = %for.set.end.i, %final_if_label.i
  ...
  %4 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %result_5.i) #5
  %5 = tail call i32 @putchar(i32 10) #5
  ret void
}
...
pre_entry:
  %cond_0.not3 = icmp slt i64 %n, 4
  br i1 %cond_0.not3, label %for.set.end, label %for.set.body

for.set.body:                                     ; preds = %pre_entry, %else_lbl
  %n_18 = phi i64 [ %n_4, %else_lbl ], [ %n, %pre_entry ]
  %result_17 = phi i64 [ %result_3, %else_lbl ], [ %n, %pre_entry ]
  %p_14 = phi i64 [ %p_2, %else_lbl ], [ 2, %pre_entry ]
  %0 = srem i64 %n_18, %p_14
  %if_cond_0 = icmp eq i64 %0, 0
  br i1 %if_cond_0, label %while.body, label %else_lbl

while.body:                                       ; preds = %for.set.body, %while.body
  %n_22 = phi i64 [ %npdiv_0, %while.body ], [ %n_18, %for.set.body ]
  %npdiv_0 = sdiv i64 %n_22, %p_14
  %1 = srem i64 %npdiv_0, %p_14
  %while_cond_0 = icmp eq i64 %1, 0
  br i1 %while_cond_0, label %while.body, label %while.end

while.end:                                        ; preds = %while.body
  %resdiv_0 = sdiv i64 %result_17, %p_14
...
define dso_local i32 @main(i32 %argc, i8** nocapture readnone %argv) local_unnamed_addr {
  ...
  %.not = icmp eq i32 %1, 0
  br i1 %.not, label %for.set.body.i.i.preheader.i, label %codeRepl
...
for.set.body.i.i.preheader.i:                     ; preds = %0, %__orig_main.exit.i
  ...
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %loop_counter_11.i) #5
...
for.set.body.i.i.i:                               ; preds = %else_lbl.i.i.i, %for.set.body.i.i.preheader.i
  ...
  %p_14.i.i.i = phi i64 [ %p_2.i.i.i, %else_lbl.i.i.i ], [ 2, %for.set.body.i.i.preheader.i ]
  %4 = srem i64 %n_18.i.i.i, %p_14.i.i.i
  %if_cond_0.i.i.i = icmp eq i64 %4, 0
...
while.body.i.i.i:                                 ; preds = %for.set.body.i.i.i, %while.body.i.i.i
  %n_22.i.i.i = phi i64 [ %npdiv_0.i.i.i, %while.body.i.i.i ], [ %n_18.i.i.i, %for.set.body.i.i.i ]
  %npdiv_0.i.i.i = sdiv i64 %n_22.i.i.i, %p_14.i.i.i
  %5 = srem i64 %npdiv_0.i.i.i, %p_14.i.i.i
  %while_cond_0.i.i.i = icmp eq i64 %5, 0
  br i1 %while_cond_0.i.i.i, label %while.body.i.i.i, label %while.end.i.i.i

while.end.i.i.i:                                  ; preds = %while.body.i.i.i
  %resdiv_0.i.i.i = sdiv i64 %result_17.i.i.i, %p_14.i.i.i
...
else_lbl.i.i.i:                                   ; preds = %while.end.i.i.i, %for.set.body.i.i.i
  ...
  %p_2.i.i.i = add i64 %p_14.i.i.i, 1
...
__orig_main.exit.i:                               ; preds = %final_if_label.i.i.i, %for.set.end.i.i.i
  ...
  %6 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %result_5.i.i.i) #5
