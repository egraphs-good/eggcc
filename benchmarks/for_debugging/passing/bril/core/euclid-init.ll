...
pre_entry:
  %v3_0 = icmp eq i64 %b, 0
  %v4_0 = xor i1 1, %v3_0
  br label %for.cond.5
for.cond.5:
  %cond_1 = phi i1 [ %v15_0, %for.body.5 ], [ %v4_0, %pre_entry ]
  %cond_temp_1 = phi i1 [ %v14_0, %for.body.5 ], [ %v3_0, %pre_entry ]
  %b_1 = phi i64 [ %v10_0, %for.body.5 ], [ %b, %pre_entry ]
  %a_1 = phi i64 [ %b_1, %for.body.5 ], [ %a, %pre_entry ]
  br i1 %cond_1, label %for.body.5, label %for.end.5
for.body.5:
  %v10_0 = call i64 @__mod(i64 %a_1, i64 %b_1)
  %v14_0 = icmp eq i64 %v10_0, 0
  %v15_0 = xor i1 1, %v14_0
  br label %for.cond.5
for.end.5:
  ret i64 %a_1
