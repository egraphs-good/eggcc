; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpiAjwGx/binary-search-init.ll'
...
define dso_local noalias noundef ptr @__pack(i64 %size, i64 %n1, i64 %n2, i64 %n3, i64 %n4, i64 %n5) local_unnamed_addr #4 {
pre_entry:
  %z0 = shl i64 %size, 3
...
define dso_local i64 @__binary_search(ptr nocapture readonly %array, i64 %target, i64 %left, i64 %right) local_unnamed_addr #5 {
pre_entry:
...
pre_entry:
  %z1.i = tail call dereferenceable_or_null(40) ptr @malloc(i64 40)
  store i64 %e1, ptr %z1.i, align 8
  %loc_1.i = getelementptr inbounds i64, ptr %z1.i, i64 1
  store i64 %e2, ptr %loc_1.i, align 8
  %loc_2.i = getelementptr inbounds i64, ptr %z1.i, i64 2
  store i64 %e3, ptr %loc_2.i, align 8
  %loc_3.i = getelementptr inbounds i64, ptr %z1.i, i64 3
  store i64 %e4, ptr %loc_3.i, align 8
  %loc_4.i = getelementptr inbounds i64, ptr %z1.i, i64 4
  store i64 %e5, ptr %loc_4.i, align 8
...
body.i:                                           ; preds = %call_lt.i, %body.lr.ph.i
  ...
  %midloc_0.i = getelementptr inbounds i64, ptr %z1.i, i64 %mid_1.i
  %midval_0.i = load i64, ptr %midloc_0.i, align 8
...
__binary_search.exit:                             ; preds = %call_gt.i, %body.i, %call_lt.i
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %common.ret.op.i)
  %1 = tail call i32 @putchar(i32 10)
...
loop5_body:                                       ; preds = %loop5_cond.preheader, %__orig_main.exit
  ...
  %z1.i.i = tail call dereferenceable_or_null(40) ptr @malloc(i64 40)
  store i64 %loop_counter_17, ptr %z1.i.i, align 8
  %loc_1.i.i = getelementptr inbounds i64, ptr %z1.i.i, i64 1
  store i64 %loop2_counter_16, ptr %loc_1.i.i, align 8
  %loc_2.i.i = getelementptr inbounds i64, ptr %z1.i.i, i64 2
  store i64 %loop3_counter_15, ptr %loc_2.i.i, align 8
  %loc_3.i.i = getelementptr inbounds i64, ptr %z1.i.i, i64 3
  store i64 %loop4_counter_14, ptr %loc_3.i.i, align 8
  %loc_4.i.i = getelementptr inbounds i64, ptr %z1.i.i, i64 4
  store i64 %loop5_counter_13, ptr %loc_4.i.i, align 8
...
body.i.i:                                         ; preds = %call_lt.i.i, %body.lr.ph.i.i
  ...
  %midloc_0.i.i = getelementptr inbounds i64, ptr %z1.i.i, i64 %mid_1.i.i
  %midval_0.i.i = load i64, ptr %midloc_0.i.i, align 8
...
__orig_main.exit:                                 ; preds = %call_gt.i.i, %body.i.i, %call_lt.i.i
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %common.ret.op.i.i)
  %1 = tail call i32 @putchar(i32 10)
  tail call void @free(ptr %z1.i.i)
...
attributes #5 = { nofree norecurse nosync nounwind memory(argmem: read) }
