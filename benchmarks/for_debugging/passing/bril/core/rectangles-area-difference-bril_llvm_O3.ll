; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpg9EPb1/rectangles-area-difference-init.ll'
...
loop4_body:                                       ; preds = %loop4_cond.preheader, %loop4_body
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %area_0.i.i)
  %1 = tail call i32 @putchar(i32 10)
  %area_0.i1.i = mul nuw nsw i64 %loop4_counter_11, %loop3_counter_12
  %2 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %area_0.i1.i)
  ...
  %4 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %spec.select.i)
...
pre_entry:
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %area_0.i)
  %1 = tail call i32 @putchar(i32 10)
  %area_0.i1 = mul i64 %y2, %x2
  %2 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %area_0.i1)
  %3 = tail call i32 @putchar(i32 10)
  ...
  %4 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %spec.select)
  %5 = tail call i32 @putchar(i32 10)
  ret void
}
...
pre_entry:
  %area_0 = mul i64 %y, %x
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %area_0)
  %1 = tail call i32 @putchar(i32 10)
  ret i64 %area_0
}
