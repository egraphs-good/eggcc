; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmp4Gl6E8/gcd-init.ll'
...
inner_body:                                       ; preds = %inner_cond.preheader, %__orig_main.exit
  ...
  %v2_01.i = icmp ult i64 %loop_counter_12, %inner_counter_11
  %v3_12.i = sub nsw i64 %loop_counter_12, %inner_counter_11
  %v3_03.i = sub nsw i64 %inner_counter_11, %loop_counter_12
...
update.val.i:                                     ; preds = %inner_body, %update.val.i
  ...
  %v0_17.i = phi i64 [ %v0_1.v3_2.i, %update.val.i ], [ %loop_counter_12, %inner_body ]
...
__orig_main.exit:                                 ; preds = %update.val.i, %inner_body
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %v1_1.lcssa.i)
  %1 = tail call i32 @putchar(i32 10)
...
program.end:                                      ; preds = %update.val, %pre_entry
  ...
  %0 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %v1_1.lcssa)
  %1 = tail call i32 @putchar(i32 10)
  ret void
}
...
inner_body.i:                                     ; preds = %__orig_main.exit.i, %inner_cond.preheader.i
  ...
  %v2_01.i.i = icmp ult i64 %loop_counter_12.i, %inner_counter_11.i
  %v3_12.i.i = sub nsw i64 %loop_counter_12.i, %inner_counter_11.i
  %v3_03.i.i = sub nsw i64 %inner_counter_11.i, %loop_counter_12.i
...
update.val.i.i:                                   ; preds = %inner_body.i, %update.val.i.i
  ...
  %v0_17.i.i = phi i64 [ %v0_1.v3_2.i.i, %update.val.i.i ], [ %loop_counter_12.i, %inner_body.i ]
...
__orig_main.exit.i:                               ; preds = %update.val.i.i, %inner_body.i
  ...
  %4 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.2, i64 %v1_1.lcssa.i.i)
