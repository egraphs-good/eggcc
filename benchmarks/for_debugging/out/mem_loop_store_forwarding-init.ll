...
define dso_local void @__main(i1 %cond) {
pre_entry:
  %z0 = mul i64 3, 8
  %z1 = call i8* @malloc(i64 %z0)
  %p_0 = bitcast i8* %z1 to i64*
  %q_0 = getelementptr inbounds i64, i64* %p_0, i64 1
  %r_0 = getelementptr inbounds i64, i64* %p_0, i64 2
  br label %loop
loop:
  %q_1 = phi i64* [ %p_1, %loop ], [ %q_0, %pre_entry ]
  %p_1 = phi i64* [ %q_1, %loop ], [ %p_0, %pre_entry ]
  br i1 %cond, label %loop, label %done
done:
  store i64 10, i64* %q_1
  store i64 20, i64* %r_0
  %res_0 = load i64, i64* %q_1
  call void @print_int(i64 %res_0)
  call void @print_newline()
  %z2 = bitcast i64* %p_1 to i8*
...
define dso_local i32 @main(i32 %argc, i8** %argv) {
  ...
  %5 = sub nsw i32 %4, 1
  %6 = icmp ne i32 %5, 1  ; NUM ARGS
  br i1 %6, label %7, label %11

7:
  %8 = load i32, i32* %2, align 4
  %9 = sub nsw i32 %8, 1
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i64 0, i64 0), i32 1, i32 %9)
...
11:
  ...
  %t0_0 = getelementptr inbounds i8*, i8** %12, i64 1
  %t0_1 = load i8*, i8** %t0_0, align 8
  %t0_2 = call i32 @btoi(i8* %t0_1)
  %a0 = trunc i32 %t0_2 to i1
  
  call void @__main(i1 %a0)
  ret i32 0
}
