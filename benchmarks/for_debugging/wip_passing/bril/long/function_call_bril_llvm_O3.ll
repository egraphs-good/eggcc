; ModuleID = '/var/folders/jw/f07sz9zx0wqck930wjllkpyr0000gn/T/.tmpxrR903/compile.ll'
...
m_nonzero3:                                       ; preds = %m_nonzero2
  ...
  %0 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %starting_m) #3
...
2:                                                ; preds = %0
  tail call void @__orig_main(i64 25) #3
  ret i32 0
}
