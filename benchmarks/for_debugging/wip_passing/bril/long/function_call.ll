...
m_nonzero3:
  ...
  %cond_m_3 = phi i1 [ %cond_m_2, %m_nonzero3 ], [ %cond_m_2, %m_nonzero2 ], [ %cond_m_1, %m_nonzero ], [ %cond_m_0, %pre_entry ]
  %m_4 = phi i64 [ %m_3, %m_nonzero3 ], [ %m_2, %m_nonzero2 ], [ %m_1, %m_nonzero ], [ %starting_m, %pre_entry ]
